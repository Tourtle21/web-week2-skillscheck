...
let faveColors = ['blue', 'purple', 'orange'];// CODE HERE
...
let me = {
    firstName: "Kaden",
    superHeroName: "Magic Head",
    homeTown: "Haines, Alaska", 
    superPowers: ["Spontaneus Conjuring", "Infliction of Emotions", "Brain Telekenisis"],
...
let regularName = me.firstName;// CODE HERE
